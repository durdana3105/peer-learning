...
const filters = ["All", "AI/ML", "Web Dev", "DSA", "Design", "Python"];
...
const DiscoverPeerCard = memo(
  ({ user, isOnline, onConnect, isConnected }: any) => {
    return (
      <motion.div
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        if (conns) {
          const connectedIds = conns.map((c: any) =>
    ...
    const fetchPeers = async () => {
      ...
      try {
        ...
        if (selectedFilter !== "All")
          searchParams.append("filter", selectedFilter);
        ...
        if (session) {
          const res = await fetch(
            `${API_BASE_URL}/api/match/supabase-discover?${searchParams.toString()}`,
            {
              headers: {
      ...
      <div className="relative z-10 px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-gray-400 mt-1">Netflix for Learning 🚀</p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 text-lg max-w-2xl">
              Discover peers based on your goals, skills, interests, and
              learning vibe.
            </p>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-3xl font-bold">Recommended Peers</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            <Users size={70} className="mx-auto text-red-400 mb-6" />
          ...
          <div className="text-center py-24">
            <Users size={70} className="mx-auto text-gray-500 mb-6" />

            <h2 className="text-3xl font-bold mb-3">No Matches Found 😔</h2>

            <p className="text-gray-400">Try another skill or search term.</p>
          </div>
        ) : (
          <>
            <motion.div
