      ...
      <section className="container px-6 pb-24">
        ...
        >
          ...
          <div className="relative z-10 mt-10 flex flex-wrap justify-center gap-5">
            <Button
              asChild
              className="rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-500 px-8 py-7 text-black transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="container flex flex-col justify-around gap-8 md:flex-row">
          ...
          <div className="flex flex-wrap gap-10 text-slate-300">
            <div className="flex flex-col gap-3">
              <h2 className="text-cyan-500 text-xl flex items-center gap-1">
                <LayoutGrid />
                Platform
              </h2>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col justify-center items-start gap-3">
                ...
                <a
                  href="https://github.com/durdana3105/peer-learning/discussions"
                  className="transition hover:text-cyan-400 hover:translate-x-1"
                >
                  › Discussions
                </a>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col justify-center items-start gap-3">
                ...
                <Link
                  to="https://github.com/durdana3105/peer-learning/issues"
                  className="transition hover:text-cyan-400 hover:translate-x-1"
                >
                  › Report an issue
                </Link>
